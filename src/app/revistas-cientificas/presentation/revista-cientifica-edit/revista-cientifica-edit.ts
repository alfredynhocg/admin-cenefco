...
@Component({
  selector: 'app-revista-cientifica-edit',
  standalone: true,
  imports: [ReactiveFormsModule, RouterLink, NgIcon, PageTitle],
  templateUrl: './revista-cientifica-edit.html',
})
export class RevistaCientificaEdit {
  ...
  constructor() {
    this.service.getById(this.id).subscribe({
      ...
      error: () => { this.toast.error('Error', 'No se pudo cargar'); this.router.navigate(['/cenefco/revistas-cientificas']); },
    });
  }
  ...
  onSubmit(): void {
    ...
    this.service.update(this.id, this.form.value as any).subscribe({
      next: () => { this.toast.success('¡Actualizado!', 'Revista científica actualizada'); this.router.navigate(['/cenefco/revistas-cientificas']); },
