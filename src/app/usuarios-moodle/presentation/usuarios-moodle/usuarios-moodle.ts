...
import { UsuarioMoodleListResponse } from '../../domain/models/usuario-moodle.model';
import { ToastService } from '../../../common/application/services/toast.service';
import Swal from 'sweetalert2';

type S = { type: 'loading' } | { type: 'success'; response: UsuarioMoodleListResponse } | { type: 'error' } | { type: 'forbidden' };
const L: S = { type: 'loading' };
const E: S = { type: 'error' }; const F: S = { type: 'forbidden' };

@Component({
  selector: 'app-usuarios-moodle',
  imports: [NgIcon, Pagination, PageTitle, RouterLink],
  templateUrl: './usuarios-moodle.html',
})
export class UsuariosMoodle {
